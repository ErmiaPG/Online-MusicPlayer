      ...
      <li class="nav-item dropdown">
        ...
        a class="nav-link dropdown-toggle" href="/" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Contact Us</a>
                            <div class="dropdown-menu" aria-labelledby="dropdown01">
                                ...
                                <a class="dropdown-item" href="https://www.instagram.com/ermiaparsaa" target="_blank">Instagram</a>
  ...
  <main role="main">
    <div class="jumbotron">
      <div class="col-sm-8 mx-auto">
        ...
        <p>
          <a class="btn btn-primary" href="/" role="button"> Go the Musics &raquo;</a>
        </p>
      </div>
    </div>
  </main>
  ...
  <div class="container main-footer">
    <aside class="footer-sidebar widget-area row" role="complementary">
      <div class="footer-column footer-column-1 col-12 col-sm-4 col-lg-6">
        <div id="text-1" class="wd-widget widget footer-widget  widget_text">
