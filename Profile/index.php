<?php
    ...
    if($Loged_in == false)
    { header('location: http://onlinemusicplayerproject.gigfa.com');;}
...
<main>
        <div class="container">
			<div class="row m-b-r m-t-3">
				...
				<div>
          <h2 class="h2-responsive" style="color:lightblue;">@<?php echo $_SESSION['user']?> <form method="GET" action="/Profile/EditProfile"><input type="submit" class="btn btn-primary btn-lg"value="Edit Profile"></form></h2>
          <form action="" method="GET">
          <input class="btn-hover color-1" type="submit" name="submit-logout"value="Logout">
          </form>
